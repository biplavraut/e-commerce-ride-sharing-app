<template>
  <app-card
    :title="edit ? 'Modify <b>Discount</b>':'Edit <b>Discount</b>'" >
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      let { appliedFrom,appliedTill,discountType,discountValue,status } = data.data;
      this.form = new Form({
            appliedFrom,
            appliedTill,
            discountType,
