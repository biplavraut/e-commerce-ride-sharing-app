<template>
  <div class="row">
    <div class="col-md-7">
      <app-card :title="edit ? 'Edit ' + form.code : 'Add New <b>Utility Voucher</b>'">
...
export default {
  ...
  methods: {
    ...
    addUser(userId, userName) {
      ...
      this.searchKeyword = "";
      const code = "UVGG" + randomString(8).toUpperCase();
