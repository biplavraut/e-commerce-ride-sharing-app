...
<body>
    <span class="preheader">gogo20 has invited you as gogo20 System user.</span>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi, {{ $user->name }}!</h1>
                                            <p>gogo20 has invited you as gogo20 System user. Use the button below to login to your account and get started:</p>
                                            <!-- Action -->
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ env('APP_URL', 'https://gogo20.com') }}/admin" class="f-fallback button" target="_blank">Login to account</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <p><strong>P.S.</strong> Do not share the credentials provided above, and change your password after you login.</p>
                                            <!-- Sub copy -->
