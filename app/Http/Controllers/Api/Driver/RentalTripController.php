...
class RentalTripController extends Controller
{
    public function list()
    {
        ...
        return RentalTripResource::collection($driver->rentalTrips()->latest()->get())->additional(['status' => true, 'message' => "", 'statusCode' => 200], 200);
    }
    ...
    public function markAsCompleted(Request $request)
    {
        ...
        if (!$trip = RentalTrip::where('id', $request->tripId)->where('driver_id', $driver->id)->first()) {
        ...
        return successResponse('Rental Trip has been set to completed.', 200, 200);
    }
