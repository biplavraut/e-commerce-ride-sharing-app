...
class ProductResource extends CommonResource
{
    ...
    public function toArrayWithoutNullValues($request)
    {
        ...
        return [
            ...
            'badge' => $this->badge,
            'price' => $this->price,
            'elite_percent' => $this->elite_percent,
            'price1' => $this->price_1,
            ...
            'images' => $this->images->map(function ($image) {
                return ['image' => $image->watermarkImage(150, 150), 'id' => $image->id];
            }),
            ...
            'update' => $this->productUpdate ? new ProductLessUpdateResource($this->productUpdate) : nullValue(),
            'type' => $this->isVerified() ? (in_array($this->service['slug'], $serviceProducts) ? 'service' : 'product') : 'unverified'
        ];
    }
}
